...
if __name__ == '__main__':
    ...
    origin_aug = params.ft_augmentation
    if origin_aug == "randomresizedcrop":
        aug_type = "rcrop_"
        aug_intensity_lst = [0.2, 0.4, 0.6, 0.8]
    elif origin_aug == "base":
        aug_type = "base_"
        aug_intensity_lst = ["weaker", "weak", "strong", "stronger"]
    elif origin_aug == "randomcolorjitter":
        aug_type = "cjitter_"
        aug_intensity_lst = [0.2, 0.4, 0.6, 0.8]
        
    for target in targets:
        params.target_dataset = target
        for aug_intensity in aug_intensity_lst:
            params.ft_augmentation = aug_type + str(aug_intensity)
            main(params)