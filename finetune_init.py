...
def main(params):
    ...
    output_dir = output_dir.replace("experiment/perplexity/resnet10_simclr_LS_default", "ordering/analysis2/effect_init")
    ...
    df_acc = pd.DataFrame(None, index=list(range(1, n_episodes + 1)),
                            columns=[e + 1 for e in range(600)])
    ...
    for episode in range(n_episodes):
        ...
        for init in range(600):
            ...
            head_state =  torch.load('./classifier_init/random_init_{:03d}.pt'.format(init))
