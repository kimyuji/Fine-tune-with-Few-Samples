...
def main(params):
    ...
    if params.ft_cutmix:
        train_history_path = train_history_path.replace('.csv', '_mixup3.csv')
        test_history_path = test_history_path.replace('.csv', '_mixup3.csv')
    ...
    for episode in range(n_episodes):
        ...
        for epoch in range(n_epoch):
            ...
            x_support_copy = lam * x_support[rand_index,:,:] + (1-lam) * x_support[rand_index,:,:]
