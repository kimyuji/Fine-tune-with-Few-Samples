...
def main(params):
    ...
    for intensity in aug_intensity:
        ...
        query_tta_loader = get_labeled_episodic_dataloader(params.target_dataset, n_way=w, n_shot=s, support=False,
                                                        ...
                                                        augmentation=aug_param, # augmentation based on strength
                                                        unlabeled_ratio=0,
                                                        num_workers=params.num_workers,
                                                        split_seed=params.split_seed,
                                                        episode_seed=params.ft_episode_seed,
        ...
        test_tta_history_path = get_ft_test_tta_history_path(output_dir, params).replace('.csv', '_{}.csv'.format(intensity))
